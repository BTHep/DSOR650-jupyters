...
import os
for dirname, _, filenames in os.walk(r'C:\Users\Orbix\OneDrive\Desktop\archive'):
...
path = "C:/Users/Orbix/OneDrive/Desktop/plants/Train"
train = image_dataset_from_directory(path, batch_size=32,
                                    image_size=(256,256),shuffle=True)

path = "C:/Users/Orbix/OneDrive/Desktop/plants/Test"
test = image_dataset_from_directory(path, batch_size=32,
                                    image_size=(256,256),shuffle=True)

path = "C:/Users/Orbix/OneDrive/Desktop/plants/Validation"
